...
def test_btc_strong_bullish(kline_factory):
    ...
    result = evaluate_btc_filter(candles, MacdResult(2, 1, 1), CvdResult(10, 5, True, False, "UP"), StructureState("RANGE", False, False, False, False, 119, 90))
...
def test_btc_strong_bearish(kline_factory):
    ...
    result = evaluate_btc_filter(candles, MacdResult(-2, -1, -1), CvdResult(-10, -5, False, True, "DOWN"), StructureState("RANGE", False, False, False, False, 120, 81))
